...
private:
	...
	// set_physics_override(self, override_table)
	static int l_native_set_physics_override(lua_State *L);

	// get_physics_override(self)
	static int l_native_get_physics_override(lua_State *L);
	...
	// get_rotation(self)
	static int l_native_get_rotation(lua_State *L);

	// set_yaw(self, yaw)
	static int l_native_set_yaw(lua_State *L);

	// get_yaw(self)
	static int l_native_get_yaw(lua_State *L);

	// set_texture_mod(self, mod)
	static int l_native_set_texture_mod(lua_State *L);

	// l_get_texture_mod(self)
	static int l_native_get_texture_mod(lua_State *L);

	// set_sprite(self, start_frame, num_frames, framelength, select_x_by_camera)
	static int l_native_set_sprite(lua_State *L);

	// DEPRECATED
	// get_entity_name(self)
	static int l_native_get_entity_name(lua_State *L);

	// get_luaentity(self)
	static int l_native_get_luaentity(lua_State *L);

	/* Player-only */

	// get_player_name(self)
	static int l_native_get_player_name(lua_State *L);
	...
	// DEPRECATED
	// get_look_pitch(self)
	static int l_native_get_look_pitch(lua_State *L);

	// DEPRECATED
	// get_look_yaw(self)
	static int l_native_get_look_yaw(lua_State *L);
	...
	// set_fov(self, degrees, is_multiplier, transition_time)
	static int l_native_set_fov(lua_State *L);

	// set_look_vertical(self, radians)
	static int l_native_set_look_vertical(lua_State *L);

	// set_look_horizontal(self, radians)
	static int l_native_set_look_horizontal(lua_State *L);

	// DEPRECATED
	// set_look_pitch(self, radians)
	static int l_native_set_look_pitch(lua_State *L);

	// DEPRECATED
	// set_look_yaw(self, radians)
	static int l_native_set_look_yaw(lua_State *L);

	// set_breath(self, breath)
	static int l_native_set_breath(lua_State *L);

	// get_breath(self, breath)
	static int l_native_get_breath(lua_State *L);

	// DEPRECATED
	// set_attribute(self, attribute, value)
	static int l_native_set_attribute(lua_State *L);

	// DEPRECATED
	// get_attribute(self, attribute)
	static int l_native_get_attribute(lua_State *L);

	// get_meta(self)
	static int l_native_get_meta(lua_State *L);

	// set_inventory_formspec(self, formspec)
	static int l_native_set_inventory_formspec(lua_State *L);

	// get_inventory_formspec(self)
	static int l_native_get_inventory_formspec(lua_State *L);

	// set_formspec_prepend(self, formspec)
	static int l_native_set_formspec_prepend(lua_State *L);

	// get_formspec_prepend(self)
	static int l_native_get_formspec_prepend(lua_State *L);

	// get_player_control(self)
	static int l_native_get_player_control(lua_State *L);

	// get_player_control_bits(self)
	static int l_native_get_player_control_bits(lua_State *L);

	// hud_add(self, id, form)
	static int l_native_hud_add(lua_State *L);

	// hud_rm(self, id)
	static int l_native_hud_remove(lua_State *L);

	// hud_change(self, id, stat, data)
	static int l_native_hud_change(lua_State *L);

	// hud_get(self, id)
	static int l_native_hud_get(lua_State *L);

	// hud_set_flags(self, flags)
	static int l_native_hud_set_flags(lua_State *L);

	// hud_get_flags()
	static int l_native_hud_get_flags(lua_State *L);

	// hud_set_hotbar_itemcount(self, hotbar_itemcount)
	static int l_native_hud_set_hotbar_itemcount(lua_State *L);

	// hud_get_hotbar_itemcount(self)
	static int l_native_hud_get_hotbar_itemcount(lua_State *L);

	// hud_set_hotbar_image(self, name)
	static int l_native_hud_set_hotbar_image(lua_State *L);

	// hud_get_hotbar_image(self)
	static int l_native_hud_get_hotbar_image(lua_State *L);

	// hud_set_hotbar_selected_image(self, name)
	static int l_native_hud_set_hotbar_selected_image(lua_State *L);

	// hud_get_hotbar_selected_image(self)
	static int l_native_hud_get_hotbar_selected_image(lua_State *L);

	// set_sky(self, sky_parameters)
	static int l_native_set_sky(lua_State *L);

	// get_sky(self)
	static int l_native_get_sky(lua_State *L);

	// get_sky_color(self)
	static int l_native_get_sky_color(lua_State *L);

	// set_sun(self, sun_parameters)
	static int l_native_set_sun(lua_State *L);

	// get_sun(self)
	static int l_native_get_sun(lua_State *L);

	// set_moon(self, moon_parameters)
	static int l_native_set_moon(lua_State *L);

	// get_moon(self)
	static int l_native_get_moon(lua_State *L);

	// set_stars(self, star_parameters)
	static int l_native_set_stars(lua_State *L);

	// get_stars(self)
	static int l_native_get_stars(lua_State *L);

	// set_clouds(self, cloud_parameters)
	static int l_native_set_clouds(lua_State *L);

	// get_clouds(self)
	static int l_native_get_clouds(lua_State *L);

	// override_day_night_ratio(self, type)
	static int l_native_override_day_night_ratio(lua_State *L);

	// get_day_night_ratio(self)
	static int l_native_get_day_night_ratio(lua_State *L);

	// set_local_animation(self, idle, walk, dig, walk_while_dig, frame_speed)
	static int l_native_set_local_animation(lua_State *L);

	// get_local_animation(self)
	static int l_native_get_local_animation(lua_State *L);

	// set_eye_offset(self, firstperson, thirdperson)
	static int l_native_set_eye_offset(lua_State *L);

	// get_eye_offset(self)
	static int l_native_get_eye_offset(lua_State *L);
	...
	// set_minimap_modes(self, modes, wanted_mode)
	static int l_native_set_minimap_modes(lua_State *L);
